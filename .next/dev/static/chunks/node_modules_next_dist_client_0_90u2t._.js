...
function readSegmentCacheEntryForNavigation(now, varyPath, restrictToShell = false) {
    const isRevalidation = false;
    if ("TURBOPACK compile-time truthy", 1) {
        const { getCurrentNavigationLock } = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/segment-cache/navigation-testing-lock.js [app-client] (ecmascript)");
...
navigationLockPrefetch) {
    ...
    if (existingEntry !== null) {
        if (("TURBOPACK compile-time value", true) && navigationLockPrefetch !== null) {
            ...
            const { getCurrentNavigationLock, trackNavigationLockPrefetchEntry } = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/segment-cache/navigation-testing-lock.js [app-client] (ecmascript)");
            const lock = getCurrentNavigationLock();
...
function createDetachedSegmentCacheEntry(now) {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        ...
        const { recordNavigationLockOwnedEntry } = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/segment-cache/navigation-testing-lock.js [app-client] (ecmascript)");
...
function upgradeToPendingSegment(emptyEntry, fetchStrategy, navigationLockPrefetch) {
    ...
    navigationLockPrefetch !== null) {
        const { trackNavigationLockPrefetchEntry } = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/segment-cache/navigation-testing-lock.js [app-client] (ecmascript)");
            ...
            case 2:
                if (task.phase === 2) {
                    ...
                    if (("TURBOPACK compile-time value", true) && task._navigationLockPrefetch != null) {
                        ...
                        const { finishNavigationLockPrefetchSpawning } = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/segment-cache/navigation-testing-lock.js [app-client] (ecmascript)");
