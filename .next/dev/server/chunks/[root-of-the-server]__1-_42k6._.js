...
async function POST(req) {
    try {
        ...
        const passwordHash = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(password);
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].user.create({
            data: {
                name,
                email: email.toLowerCase().trim(),
                passwordHash,
        ...
        response.cookies.set({
            name: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuthTokenName"])(),
            value: token,
            httpOnly: true,
            path: '/',
            sameSite: 'lax',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1-_42k6._.js.map